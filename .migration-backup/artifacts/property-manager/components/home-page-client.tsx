...
export default function HomePageClient({ initialProperties }: { initialProperties: PropertyWithLandlord[] }) {
  ...
  useEffect(() => {
    if (activeTab === 'Rent' && initialProperties.length > 0) {
      // Use initial properties for Rent tab to avoid duplicate fetch

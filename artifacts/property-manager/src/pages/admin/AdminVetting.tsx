...
import {
  Search, CheckCircle, XCircle, Ban, Clock,
...
export default function AdminVetting() {
  ...
  return (
    <AuthGuard require="admin">
      ...
      <div className="flex h-screen overflow-hidden bg-[#F4F6FB] dark:bg-slate-950">
...
function ListingsTab({
  ...
  return (
    <div className="flex flex-1 min-h-0 overflow-hidden flex-col rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-900">
      <div className="shrink-0 flex items-center justify-between gap-4 px-4 py-3 sm:px-6 sm:py-5 border-b border-slate-100 dark:border-slate-800">
        <div>
          <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-slate-400">Listing Approvals</p>
          <h3 className="mt-1 text-base font-semibold text-[#0B1F4D] dark:text-white">
        ...
        {listings.length > 0 && (
          <div className="inline-flex items-center gap-2 text-xs text-violet-700 bg-violet-50 border border-violet-200 rounded-full px-4 py-2 font-semibold shrink-0 dark:bg-violet-950/40 dark:border-violet-800/60 dark:text-violet-300">
...
function ListingCard({
  ...
  return (
    <div className="flex flex-col rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden hover:shadow-md hover:border-slate-300 transition-all dark:border-slate-700 dark:bg-slate-900">
      ...
      <div className="flex-1 p-4">
        <h4 className="text-sm font-semibold text-slate-900 line-clamp-2 leading-snug dark:text-white">{listing.title}</h4>
        ...
        <div className="mt-3 flex items-center justify-between">
          <p className="text-lg font-semibold text-slate-950 dark:text-white">{fmtNaira(listing.price)}</p>
        ...
        <div className="mt-3 flex items-center gap-2 rounded-2xl border border-slate-100 bg-slate-50 px-3 py-2.5 dark:border-slate-700 dark:bg-slate-800">
          ...
          <span className="ml-auto shrink-0 text-[10px] font-bold text-slate-400 bg-slate-200 rounded-full px-2 py-0.5 dark:bg-slate-700 dark:text-slate-300">Submitted</span>
        </div>
      </div>
        ...
        {isConfirming ? (
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-3 dark:border-slate-700 dark:bg-slate-800">
            ...
            <div className="flex gap-2">
              <button onClick={() => setConfirm(null)}
                className="flex-1 rounded-xl border border-slate-200 bg-white py-2 text-xs font-semibold text-slate-600 hover:bg-slate-100 transition-colors dark:border-slate-600 dark:bg-slate-900 dark:text-slate-300 dark:hover:bg-slate-700">
                Cancel
              </button>
              <button
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              disabled={busy}
              className="flex-1 flex items-center justify-center gap-1.5 rounded-2xl border border-red-200 bg-red-50 hover:bg-red-100 text-red-700 py-2.5 text-xs font-bold transition-colors disabled:opacity-60 dark:border-red-800/60 dark:bg-red-950/40 dark:text-red-300 dark:hover:bg-red-950/60">

                ...
                <section className="space-y-3">
                  ...
                  <div className="rounded-xl border border-slate-200 bg-white px-4 py-3 shadow-sm">
                    <div className="flex items-center justify-between gap-3 flex-wrap">
                      ...
                      <div className="shrink-0 rounded-lg bg-slate-50 px-2.5 py-1 text-[11px] font-semibold text-slate-600 ring-1 ring-slate-100">Showing {filtered.length.toLocaleString()} of {items.length.toLocaleString()}</div>
                    </div>

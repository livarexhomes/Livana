    ...
    <div className="min-h-screen flex bg-white">
      ...
      <div className="flex-1 flex flex-col justify-center px-6 sm:px-12 lg:px-16 py-12">
        <div className="max-w-md w-full mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-500 text-base">Create a free LIVAREX account and start finding your next verified home.</p>
          </div>
      ...
      <div className="hidden lg:flex lg:w-[45%] xl:w-[48%] bg-gray-950 flex-col justify-between p-12 xl:p-16 relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-3">
          {['Free to browse — no sign-up cost', 'Verified properties only', 'Secure inspection requests'].map(item => (

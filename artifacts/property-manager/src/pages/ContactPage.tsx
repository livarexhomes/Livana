...
const channels = [
  { icon: Mail,          label: 'Email',     value: 'support@livarex.com.ng', href: 'mailto:support@livarex.com.ng', note: 'Reply within 1–2 business days', color: 'bg-blue-600',    shadow: 'shadow-blue-500/20',   ring: 'hover:ring-blue-200' },
  { icon: Phone,         label: 'Phone',     value: '+234 706 052 8437',    href: 'tel:+2347060528437',       note: '24 hours service',              color: 'bg-emerald-600', shadow: 'shadow-emerald-500/20',ring: 'hover:ring-emerald-200'},
  { icon: MessageCircle, label: 'WhatsApp',  value: '+234 706 052 8437',    href: 'https://wa.me/2347060528437', note: 'Direct landlord support',        color: 'bg-[#25D366]', shadow: 'shadow-green-500/20', ring: 'hover:ring-green-200' },
  { icon: MapPin,        label: 'Office',    value: 'Joju, Sango Ota, Ogun State', href: 'https://maps.google.com/?q=Joju+Sango+Ota+Ogun+State+Nigeria', note: 'Office location', color: 'bg-rose-600', shadow: 'shadow-rose-500/20', ring: 'hover:ring-rose-200' },
  { icon: Globe,        label: 'Website',   value: 'livarex.com.ng', href: 'https://livarex.com.ng', note: 'Visit our website for listings', color: 'bg-slate-800', shadow: 'shadow-slate-500/20', ring: 'hover:ring-slate-200' },
]

    ...
    <footer className="bg-gray-950 text-gray-400">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 pt-16 pb-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 pb-12 border-b border-white/8">
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex items-center gap-3 mt-6">
              {['twitter', 'instagram', 'linkedin'].map(platform => (
                <a key={platform} href="#" className="w-9 h-9 rounded-xl bg-white/6 hover:bg-blue-600 border border-white/8 flex items-center justify-center transition-all hover:border-blue-600">
          ...
          <div>
            <h4 className="text-white font-semibold text-sm mb-5 tracking-wide uppercase text-xs">Explore</h4>
            <ul className="space-y-3 text-sm">
              <li><Link href="/listings" className="hover:text-white transition-colors hover:translate-x-0.5 inline-block">All Listings</Link></li>
              <li><Link href="/listings?type=rent" className="hover:text-white transition-colors hover:translate-x-0.5 inline-block">For Rent</Link></li>
              <li><Link href="/listings?type=sale" className="hover:text-white transition-colors hover:translate-x-0.5 inline-block">For Sale</Link></li>
              <li><Link href="/listings?type=commercial" className="hover:text-white transition-colors hover:translate-x-0.5 inline-block">Commercial</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-500">© {new Date().getFullYear()} Livana. All rights reserved.</p>

        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-10 pb-12 border-b border-white/8">
          <div className="col-span-2 md:col-span-1 mb-2 md:mb-0">
            ...
            <p className="text-sm leading-relaxed text-gray-400 max-w-xs">
              Nigeria's verified property marketplace for vetted landlords, quality tenants and safer property search.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><Link href="/" className="hover:text-white transition-colors hover:translate-x-0.5 inline-block">Homepage</Link></li>
              <li><Link href="/about" className="hover:text-white transition-colors hover:translate-x-0.5 inline-block">About</Link></li>
              <li><Link href="/#how-it-works" className="hover:text-white transition-colors hover:translate-x-0.5 inline-block">How It Works</Link></li>
              <li><Link href="/for-landlords" className="hover:text-white transition-colors hover:translate-x-0.5 inline-block">For Landlords</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link href="/for-landlords" className="hover:text-white transition-colors">List a Property</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                Joju, Sango Ota, Ogun State, Nigeria
              </li>

...
export type ActionVariant = 'reject' | 'suspend' | 'reset'
...
export default function ReviewActionCard({
  ...
  return (
    <button
      ...
      className={cn(
        'group flex flex-col items-start gap-2 rounded-2xl border-2 bg-white p-4 text-left transition-all duration-200 ease-out hover:-translate-y-0.5 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-slate-900 motion-reduce:transform-none motion-reduce:transition-none',
        styles.border,
        styles.hover,

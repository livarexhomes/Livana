    ...
    <header className="flex items-center justify-between px-3 md:px-6 py-2 md:py-3.5 bg-white border-b border-gray-100 shrink-0 gap-3 h-14 md:h-auto">
      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        <div ref={searchRef} className="relative">
          {showSearch ? (
            <div className="flex items-center gap-2 bg-white border border-slate-950 rounded-xl px-3 py-2 w-[calc(100vw-6.5rem)] max-w-56 md:max-w-none md:w-72 shadow-sm transition-all">
          ...
          {showSearch && (searching || results.length > 0 || query.trim()) && (
            <div className="absolute top-full right-0 mt-2 bg-white rounded-2xl shadow-xl border border-slate-100 py-2 z-50 overflow-hidden w-[280px] max-w-[calc(100vw-8rem)]">
              {searching && (

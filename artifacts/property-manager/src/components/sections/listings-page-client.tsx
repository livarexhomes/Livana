          ...
          <div className={`flex-1 p-4 grid gap-3 content-start ${
            ...
            {loading ? (
              ...
              <div className="text-center py-20">
                ...
                <h3 className="text-lg font-bold text-gray-700 mb-2">No properties match your filters</h3>
                <p className="text-sm text-gray-500 mb-6">Try broadening your search, or clear all filters to see everything available.</p>
                <button
              ...
              /* No inventory at all — request flow */
              <div className="text-center py-20 max-w-md mx-auto">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">Inventory coming soon</h3>
                <p className="text-sm text-gray-500 mb-2 leading-relaxed">
                  We're onboarding verified landlords across Lagos and Ogun right now.
                </p>
                <p className="text-sm text-gray-500 mb-8 leading-relaxed">
                  Tell us what you're looking for and we'll reach out as soon as a match is available — no agent fees, ever.
                </p>
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                  ...
                  <Link
                    href="/contact"
                    className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-gray-900 hover:bg-gray-800 text-white text-sm font-semibold rounded-xl transition-colors"
                  >
                    Get in Touch
                  </Link>
                </div>
